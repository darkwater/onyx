# based on:
# https://github.com/openlab-aux/vuizvui/blob/master/pkgs/games/humblebundle/default.nix

{ stdenv, nonredistKey, unzip, fetchurl, writeText, SDL2, libGLU_combined
...
let
  ...
  preloaderSource = writeText "starbound-preloader.c" ''
    ...
    int SteamAPI_RegisterCallback(void) {
      return 0;
    }

    int SteamAPI_RunCallbacks(void) {
      return 0;
    }
  '';
